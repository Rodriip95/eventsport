    ...
    return(
        <>
            <div class="my-3 border rounded">
                ...
                <div class="d-flex px-1 px-lg-5 mt-4">
                    <p className="w-100">Equipo</p>
                    <p className="w-100 text-center">Zona</p>
                    <p className="w-100 text-center">N° Jugadores</p>
                    <p className="w-25 text-end">Acciones</p>
                </div>
                <hr class="mx-4"/>
        ...
        <>
            <div id={"cont"+team.id} class="border rounded d-flex justify-content-between mx-1 mx-lg-4 p-2 align-items-center mb-2 position-relative">
                ...
                <div className="w-100 text-center">
                    <span>{`Zona: ${team.zona}`}</span>
                </div>
                <div class="text-center w-100">
                    <span>{team.jugadores.length}</span>
                </div>
                <div class="text-end d-flex flex-column flex-md-row">
                    <button class="btn btn-warning m-1" data-bs-toggle="modal" data-bs-target={`#team${team.id}`}>
                    ...
                    <button class="btn btn-success m-1" data-bs-toggle="modal" data-bs-target={`#${team.id}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                            <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
                        </svg>
                    </button>
                    <button class="btn btn-danger m-1" data-bs-toggle="modal" data-bs-target={`#delete${team.id}`}>
